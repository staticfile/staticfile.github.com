...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _stickyfill = __webpack_require__(7);
	...
	var vm = new _vue2.default({
	  ...
	  mounted: function mounted() {
	    ...
	    _stickyfill2.default.add(this.$refs.searchBar);
	    this.$refs.searchBar.onModeChange = function (mode) {
	      _this.sticky = mode > 0;
	    };

	    var ac1 = new _autoComplete2.default({
	      selector: this.$refs.query,
	      minChars: 1,
	      source: function source(term, response) {
	        fetch(vm.apiRoot + ('?search=' + term)).then(function (res) {
	          return res.json();
	        }).then(function (data) {
	          response(data.results.map(function (lib) {
	            return lib.name;
	          }));
	        });
	      },
	      ...
	      onSuggestionsShow: function onSuggestionsShow() {
	        document.querySelector('.autocomplete-suggestion').className += ' selected';
	      }
	    });

	    var ac2 = new _autoComplete2.default({
	  ...
	  methods: {
	    loadPopular: function loadPopular() {
	      ...
	      Promise.all(this.populars.map(function (name) {
	        return fetch(_this2.apiRoot + name).then(function (res) {
	          return res.json();
	        });
	      })).then(function (libs) {
	        _this2.loading = false;
	        _this2.libs = _this2.popular = _this2.handleResponse(libs);
	      });
	    },
	    ...
	    queryLib: function queryLib(query) {
	      ...
	      this.loading = true;
	      this.libs = [];
	      fetch(this.apiRoot + ('?search=' + query)).then(function (res) {
	        return res.json();
	      }).then(function (data) {
	    ...
	    fetchLib: function fetchLib(name) {
	      ...
	      this.loading = true;
	      this.libs = [];
	      fetch(this.apiRoot + name).then(function (res) {
	        return res.json();
	      }).then(function (data) {
	...
	*/
	...
	(function () {
	    if (true) !(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
	        return autoComplete;
	    }.call(exports, __webpack_require__, exports, module), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));else if (typeof module !== 'undefined' && module.exports) module.exports = autoComplete;else window.autoComplete = autoComplete;
	})();
...
/***/ (function(module, exports) {
	...
	function switchElementMode(el, mode) {
	    ...
	    el.mode = mode;
	    el.node.onModeChange ? el.node.onModeChange(mode) : false;
	}
